...
<body>
    <div class="navegacao">
        <nav class="navbar navbar-expand-lg"
            style="background-image: radial-gradient(#4F4F4F, #363636); border: 2px solid black;">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="cadastrarRoupa.php" style="color: #327028;">Cadastrar nova
                                roupa</a>
                        </li>
    ...
    <div class="container" style="margin-top:1rem;">
        ...
        <form method="POST" action="../control/controleRoupa.php">
            ...
            <div class="mb-3">
                ...
                <input type="color" class="form-control" id="cor" name="cor"> <!--TYPE: COLOR!-->
            </div>
            <div class="mb-3">
                <label for="preco" class="form-label">Preço:</label>
                <input type="text" class="form-control" id="preco" name="preco" data-thousands="." data-decimal="," data-prefix="R$ "><!--onkeydown="mascara(this, dinheiro)"!-->
            </div>
